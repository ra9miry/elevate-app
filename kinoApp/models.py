...
class Movie(models.Model):
    ...
    poster = models.CharField(" Link to poster ",max_length=580)
    isTop = models.BooleanField("Is top",default=True)
    isRecommended = models.BooleanField("Is recommended", default=True)
